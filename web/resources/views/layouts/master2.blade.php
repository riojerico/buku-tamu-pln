...
<head>
	...
	<title>Aplikasi Buku Tamu & WP</title>
...
<div class="wrapper">
	<div class="header header-" style="background-color: #0890d7;">
		<div class="container">
			<div class="row">
	    ...
	    <div class="section section-navbars">
	        ...
	        <div id="navbar">
	            <div class="navigation-example">
                        ...
                        <li class="{{ request()->is('working-permit') ? 'active' : '' }}">
                            <a href="{{ url('/working-permit') }}">
                                Working Permit
                            </a>
                        </li>
    ...
    <footer class="footer">
	    <div class="container">
	        ...
	        <div class="copyright pull-right">
	            &copy; {{ date('Y') }}, supported by PT WARNINDO DIGITAL INDONESIA
	        </div>
	    </div>
	</footer>
</div>
...
@yield('modal-history')
	...
	<script type="text/javascript">
		...
		$().ready(function(){
			// the body of this function is in {{ asset('material-kit.js') }}
