...
<div style="position: relative;"><img style="position: absolute; z-index: 1; left: 25px; top: -20px; width: 45px; height: 65px;" src="{{ asset('img/image001.png') }}" border="0" /></div></td>
...
<div style="position: relative;"><img style="position: absolute; z-index: 1; left: 26px; top: -20px; width: 43px; height: 65px;" src="{{ asset('img/image003.png') }}" border="0" /></div></td>
            <td class="column8">&nbsp;</td>
          </tr>
          <tr class="row1">
            <td class="column1 style65 s style65" colspan="6">FORMULIR SURAT IZIN KERJA/JOB SAFETY ANALYSIS</td>
            <td class="column8">&nbsp;</td>
          </tr>
          <tr class="row2">
          ...
          <tr class="row6">
            <td class="column0 style1 s">Pekerjaan Umum <br>
              &nbsp;@if ($a1=='on')
                <img src="{{ asset('img/box cek.jpg') }}" alt="" width="20px">
                @else
                <img src="{{ asset('img/box.jpg') }}" alt="" width="20px">
              @endif
            </td>
  ...
  &nbsp;&nbsp;&nbsp;………………………..</td>
          ...
          <tr class="row43">
            <td class="column0 style39 s style44" colspan="4" rowspan="2">Dari &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
              Tgl&nbsp;&nbsp;{{ $ftanggal }}&nbsp;&nbsp;Jam&nbsp;&nbsp;@if($fjam==false) - @else {{ $fjam }} @endif<br />
Sampai Dengan    : Tgl&nbsp;&nbsp;{{ $ftanggal2 }}&nbsp;&nbsp;Jam&nbsp;&nbsp;@if($fjam2=="") - @else {{ $fjam2 }} @endif</td>
            <td class="column4 style36 s style38" colspan="2">Asman</td>
            <td class="column6 style45 null style46" colspan="2">{{ $fasisten }}</td>
            <td class="column8">&nbsp;</td>
          </tr>
          <tr class="row44">
            <td class="column4 style36 s style38" colspan="2">SPV</td>
...
Pelaksana</td>
          ...
          <tr class="row49">
            ...
            <td class="column6 style5 null">@if($gjam=="") - @else {{ $gjam }} @endif </td>
          ...
          <tr class="row50">
            ...
            <td class="column6 style5 null">@if($gjam2=="") - @else {{ $gjam2 }}  @endif</td>
